...
#Criar o Dataset one-hot (numeros de exemplos, tamanho da sequência, numeros de caracteres) one-hot
#criar Dataset disperso (numeros de exemplos, tamanho da sequência)
